function [ SamplesInAperture ] = ChopSamplesToAperture( M, IncludedApertureElements, NumbSamples )
...
ExpandedApertureElements = repmat(IncludedApertureElements, 1, 1, NumbSamples);
